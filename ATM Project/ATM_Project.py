...
# for json module 
import json
# for tkinter library import all modules
from tkinter import *
# for messagebox module
from tkinter import messagebox
# for image import pil library
...
#     update balance
            with open("Data.json","w") as f2:
                ...
                messagebox.showinfo("Withdraw",message,icon="info")
        else:
...
#     update balance 
        with open("Data.json","w") as f2:
            ...
            messagebox.showinfo("Deposit",message,icon="info")
# display balance
def show_balance(nw8,uname):
    messagebox.showinfo("Show Balance",f"Your Current Balance is:- {data1[uname]['balance']}.",icon="info")
...
#     display balance
    balance = Button(nw1, text="Show Balance", command=lambda:show_balance(nw1,uname))
    balance.pack(pady=23)
#     back button
...
#         check username if exist or not 
    elif uname.get() in data1:
        messagebox.showinfo("Alert","Username is Already Exists.",icon="warning")
        home(nw2)
    else:
        messagebox.showinfo("Create Account","Account Created Successfully.",icon="info")
#         get account no
